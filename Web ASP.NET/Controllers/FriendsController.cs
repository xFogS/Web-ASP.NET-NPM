...
namespace Web_ASP.NET.Controllers
{
    public class FriendsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,Age")] Friend friend)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,Age")] Friend friend)
        {
            if (id != friend.Id)
            {
                return NotFound();
